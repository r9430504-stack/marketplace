...
export default function StepTheme({ value, onChange }: Props) {
  return (
    <div className="space-y-4">
      <div>
        <h2 className="text-2xl font-bold text-gray-900">Выберите стиль магазина</h2>
        <p className="text-gray-500 mt-1">Choose your store style</p>
      </div>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-6">
        {THEMES.map((theme) => (
          ...
          >
            ...
            <p className="font-semibold text-gray-900 text-sm">{theme.nameRu}</p>
